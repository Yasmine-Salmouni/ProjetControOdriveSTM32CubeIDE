...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART2)
  {
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, Ecran_TX_Pin|Ecran_RX_Pin);
  ...
  else if(huart->Instance==USART3)
  {
    ...
    PD8     ------> USART3_TX
    */
    HAL_GPIO_DeInit(Cntroller_RX_GPIO_Port, Cntroller_RX_Pin);

    HAL_GPIO_DeInit(Controller_TX_GPIO_Port, Controller_TX_Pin);
